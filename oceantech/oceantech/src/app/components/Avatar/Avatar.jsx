...
import { imageDefault } from "app/constant";
...
function CustomAvatar({
  ...
  return (
    <div
      style={{
        display: "flex",
        justifyContent: isNoneBorder ? "left" : "center",
        alignItems: "center",
        flexWrap: "wrap",
        height: isNoneBorder ? 200 : 260,
        paddingTop: isNoneBorder ? 0 : isPadding ? 28 : 32,
      }}
    >
      <div className="avatar" width="100%">
        <Image
          ...
          style={{
            borderRadius: isNoneBorder ? "" : "50%",
            zIndex: 1000,
            border: isNoneBorder ? "1px solid #E5E5E5" : "",
          }}
